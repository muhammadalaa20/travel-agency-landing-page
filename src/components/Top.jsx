    ...
    return (
        <div className="flex flex-row xl:justify-between lg:justify-between justify-center items-center">
            <div className={`${index === 0 ? "block" : "hidden"} xl:ml-8 lg:ml-8 py-20 px-3 gap-5 flex flex-col text-white`}>
                <h1 className="xl:text-8xl lg:text-7xl text-3xl">Start your unforgettable
                    journey with us.</h1>
            ...
            <div className={`${index === 1 ? "block" : "hidden"} xl:ml-8 lg:ml-8 py-20 px-3 gap-5 flex flex-col text-white`}>
                <h1 className="xl:text-8xl lg:text-7xl text-3xl text-accent">Start your unforgettable
                    journey with us.</h1>
                <p className="text-xl">The best travel for your journey begins now</p>
            </div>
            <div className={`${index === 2 ? "block" : "hidden"} xl:ml-8 lg:ml-8 py-20 px-3 gap-5 flex flex-col text-white`}>
                <h1 className="xl:text-8xl lg:text-7xl text-3xl text-blue-500">Start your unforgettable
                    journey with us.</h1>
                <p className="text-xl">The best travel for your journey begins now</p>
            </div>
            <div className={`${index === 3 ? "block" : "hidden"} xl:ml-8 lg:ml-8 py-20 px-3 gap-5 flex flex-col text-white`}>
                <h1 className="xl:text-8xl lg:text-7xl text-3xl text-orange-300">Start your unforgettable
                    journey with us.</h1>
                <p className="text-xl">The best travel for your journey begins now</p>
            </div>
            <div className={`${index === 4 ? "block" : "hidden"} xl:ml-8 lg:ml-8 py-20 px-3 gap-5 flex flex-col text-white`}>
                <h1 className="xl:text-8xl lg:text-7xl text-3xl text-pink-600">Start your unforgettable
                    journey with us.</h1>
                <p className="text-xl">The best travel for your journey begins now</p>
            </div>
